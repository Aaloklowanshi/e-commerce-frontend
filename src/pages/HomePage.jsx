  ...
  return (
    <Layout title={"ALl Products - Best offers "}>
      ...
      <div className="container-fluid row mt-3 home-page">
        <div className="col-lg-2 filters md-align-items-center">
        ...
        <div className="col-lg-10 ">
          ...
          <div className="d-flex flex-wrap col justify-content-around">
            {products?.map((p) => (
          ...
          <div className="m-2 p-3">
            ...
            {console.log("products length" + products.length + "total products" +total)}
          </div>
        </div>
      </div>
    </Layout>
